...
PTP_WAIT_CALLBACK :: #type proc "system" (Instance: PTP_CALLBACK_INSTANCE, Parameter: PVOID, Wait: PTP_WAIT, WaitResult: TP_WAIT_RESULT)
PTP_TIMER_CALLBACK :: #type proc "system" (Instance: PTP_CALLBACK_INSTANCE, Parameter: PVOID, Timer: PTP_TIMER)
PTP_WORK_CALLBACK :: #type proc "system" (Instance: PTP_CALLBACK_INSTANCE, Parameter: PVOID, Work: PTP_WORK)
...
TpSetCallbackActivationContext :: proc "c" (CallbackEnviron: PTP_CALLBACK_ENVIRON, ActivationContext: ^_ACTIVATION_CONTEXT) {
	CallbackEnviron.ActivationContext = ActivationContext
}
TpSetCallbackNoActivationContext :: proc "c" (CallbackEnviron: PTP_CALLBACK_ENVIRON, ActivationContext: ^_ACTIVATION_CONTEXT) {
...
TpSetCallbackFinalizationCallback :: proc "c" (CallbackEnviron: PTP_CALLBACK_ENVIRON, FinalizationCallback: PTP_SIMPLE_CALLBACK) {
	CallbackEnviron.FinalizationCallback = FinalizationCallback
}
TpSetCallbackPriority :: proc "c" (CallbackEnviron: PTP_CALLBACK_ENVIRON, Priority: TP_CALLBACK_PRIORITY) {
...
SetThreadpoolCallbackCleanupGroup :: proc "c" (pcbe: PTP_CALLBACK_ENVIRON, ptpcg: PTP_CLEANUP_GROUP, pfng: PTP_CLEANUP_GROUP_CANCEL_CALLBACK) {
...
SetThreadpoolCallbackPriority :: proc "c" (pcbe: PTP_CALLBACK_ENVIRON, priority: TP_CALLBACK_PRIORITY) {
